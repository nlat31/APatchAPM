...
public final class ConfigStore {
    ...
    private static final String MOD_ID = "sample";
    ...
    public static final class Config {
        ...
        public Config(boolean hookNative, boolean hookJava, Set<String> packages) {
    ...
    public static Config readConfigOrNull() {
        ...
        try {
            ...
            return new Config(
                ...
                obj.optBoolean("hook_java", false),
                pkgs
            );
        } catch (Throwable t) {
            return null;
    ...
    public static RootShell.Result writeConfig(Config cfg) {
        try {
            ...
            obj.put("hook_java", cfg != null && cfg.hookJava);
