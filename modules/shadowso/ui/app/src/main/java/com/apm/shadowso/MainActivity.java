...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnApply.setOnClickListener(v -> {
            ...
            ConfigStore.Config cfg = new ConfigStore.Config(
                ...
                vm.optHookPhdr,
                vm.optHookDladdr,
                new LinkedHashSet<>(vm.selectedPackages),
                hideSo
            );
            RootShell.Result r = ConfigStore.writeConfig(cfg);
            if (r.code == 0) {
                Toast.makeText(this, "Saved to " + ConfigStore.getConfigPath(), Toast.LENGTH_LONG).show();
            } else {
    ...
    private static List<String> parseSoList(String input) {
